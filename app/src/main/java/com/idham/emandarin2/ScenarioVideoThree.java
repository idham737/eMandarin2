...
public class ScenarioVideoThree extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {

    public static final String API_KEY = "AIzaSyByr1yDs7ha1uu23zA_cDXwShw5Gjl3uxM";
    public static final String VIDEO_ID = "gvbE0bM8bm4";
